import { Metrics, BreakdownData } from './Metrics';
import { CopilotMetrics } from './Copilot_Metrics';

/**
 * Converts the new GitHub Copilot Metrics API v2 format (CopilotMetrics)
 * to the legacy Metrics format used by the existing display components.
 */

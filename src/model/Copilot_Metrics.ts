...
interface CopilotMetricsData {
  ...
  date: string;
  /** The total number of Copilot users with activity belonging to any Copilot feature, globally, for the given day */
  total_active_users: number;
  /** The total number of Copilot users who engaged with any Copilot feature, for the given day */
  total_engaged_users: number;
...
export class CopilotIdeCodeCompletionsEditorModel {
  ...
  /** The training date for the custom model */
  custom_model_training_date?: string | null;
  /** Number of users who accepted at least one Copilot code completion suggestion for the given editor, for the given language and model */
  total_engaged_users: number;
  /** Code completion metrics for active languages, for the given editor */
...
export class CopilotIdeCodeCompletionsEditor {
  /** Name of the given editor */
  name: string;
  /** Number of users who accepted at least one Copilot code completion suggestion for the given editor */
  total_engaged_users: number;
  /** List of model metrics for custom models and the default model */
...
export class CopilotIdeCodeCompletionsLanguage {
  /** Name of the language used for Copilot code completion suggestions */
  name: string;
  /** Number of users who accepted at least one Copilot code completion suggestion for the given language */
  total_engaged_users: number;
...
export class CopilotIdeCodeCompletions {
  /** Number of users who accepted at least one Copilot code suggestion, across all active editors */
  total_engaged_users: number;
  /** Code completion metrics for active languages */
...
export class CopilotIdeChatEditorModel {
  ...
  /** The total number of chats initiated by users in the given editor and model */
  total_chats: number;
  /** The number of times users accepted a code suggestion from Copilot Chat using the 'Insert Code' UI element */
  total_chat_insertion_events: number;
...
/**
 * Copilot usage metrics for a given day (new API format)
 */
